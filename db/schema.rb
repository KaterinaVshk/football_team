...
ActiveRecord::Schema.define(version: 20_240_507_230_156) do
  ...
  create_table 'match_indicators', force: :cascade do |t|
    ...
    t.index %w[player_id indicator_id match_id],
  ...
  create_table 'players', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[player_number team_id], name: 'index_players_on_player_number_and_team_id', unique: true
  ...
  create_table 'teams', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[name country_name], name: 'index_teams_on_name_and_country_name', unique: true
  end
